...
class UnitSpecializationTraitService:
    ...
    async def get_all(self) -> List[UnitSpecializationTraitDTO]:
        return await self.database.unitspecializationtrait.find_many()

    async def get_by_id(self, id: str) -> UnitSpecializationTraitDTO:
        return await self.database.unitspecializationtrait.find_unique( 
            where={"id": id} 
        )
    ...
    async def update_unit_trait(self, id: str, unit_trait: UnitSpecializationTraitUpdateDTO) -> UnitSpecializationTraitDTO:
        ...
        # Get unit_trait Data
        unit_trait_current = await self.database.unitspecializationtrait.find_unique( 
            where={"id": id} 
        )
        ...
        return await self.database.unitspecializationtrait.update( 
            where={"id": id}, 
    ...
    async def create(self, unit_trait: UnitSpecializationTraitCreateDTO) -> UnitSpecializationTraitDTO:
        ...
        return await self.database.unitspecializationtrait.create( 
            data=data
        )

    async def delete(self, id: str) -> UnitSpecializationTraitDTO:
        return await self.database.unitspecializationtrait.delete(
            where={"id": id}
        )
    
    async def delete_by_ids(self, unit_specialization_id: str, trait_id: str) -> UnitSpecializationTraitDTO:
        unit_trait = await self.database.unitspecializationtrait.find_first(
